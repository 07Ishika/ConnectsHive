document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('enter-btn').addEventListener('click', function () {
        if (selectedDate) {
            alert("Hope you have entered valid email,please fill the affirmation form! \nNote: Slot booking confirmation will not be done if you didn't Submit an affirmation form ");
        } else {
